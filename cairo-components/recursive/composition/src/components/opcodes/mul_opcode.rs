...
pub struct Component {
    ...
    pub range_check_20_lookup_elements: RangeCheck20Var,
    pub range_check_20_b_lookup_elements: RangeCheck20BVar,
    pub range_check_20_c_lookup_elements: RangeCheck20CVar,
    pub range_check_20_d_lookup_elements: RangeCheck20DVar,
    pub range_check_20_e_lookup_elements: RangeCheck20EVar,
    pub range_check_20_f_lookup_elements: RangeCheck20FVar,
    pub range_check_20_g_lookup_elements: RangeCheck20GVar,
    pub range_check_20_h_lookup_elements: RangeCheck20HVar,
