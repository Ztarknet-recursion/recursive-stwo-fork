...
impl VerifyMul252 {
    ...
    pub fn evaluate<E: EvalAtRow<F = WrappedQM31Var, EF = WrappedQM31Var>>(
        ...
        carry_25_col26: E::F,
        carry_26_col27: E::F,
        range_check_20_lookup_elements: &RangeCheck20Var,
        range_check_20_b_lookup_elements: &RangeCheck20BVar,
        range_check_20_c_lookup_elements: &RangeCheck20CVar,
        range_check_20_d_lookup_elements: &RangeCheck20DVar,
        range_check_20_e_lookup_elements: &RangeCheck20EVar,
        range_check_20_f_lookup_elements: &RangeCheck20FVar,
        range_check_20_g_lookup_elements: &RangeCheck20GVar,
        range_check_20_h_lookup_elements: &RangeCheck20HVar,
        eval: &mut E,
    ) -> [E::F; 0] {
